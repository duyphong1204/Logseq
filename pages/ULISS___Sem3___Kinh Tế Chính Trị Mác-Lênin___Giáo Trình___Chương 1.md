	...
	- ## 1.1.3. Các yếu tố cơ bản của quá trình lao động sản xuất
		...
		- Để tiến hành hoạt động lao động sản xuất, cần có những yếu tố cơ bản
			...
			- Tư liệu lao động
				...
				- Tư liệu lao động dùng để bảo quản những đối tượng và sản phẩm lao động, gọi chung là hệ thống bình chứa của sản xuất, như là nhà kho chứa vật tư, hàng hóa; bể chứa dầu, hóa chất... Nền sản xuất cùng phát triển, nhu cầu về loại tư liệu lao động này cũng càng cao.
