		...
		- ### Một số khái niệm cơ bản
			...
			- **Các khâu của quá trình tái sản xuất**
				- Quá trình tái sản xuất có 4 khâu
					...
					- Phân phối
					  logseq.order-list-type:: number
						- Kết quả của sản xuất được phân phối cho sản xuất và cho tiêu dùng. Phân phối cho sản xuất là sự phân chia các yếu tố sản xuất cho các ngành, các cơ sở sản xuất. Trong cơ chế thị trường, phân phối cho sản xuất còn được xem xét cả về phương diện giá trị. Tỷ lệ tiết kiệm và đầu tư trong GDP là những chỉ số trực tiếp tác động đến tốc độ tăng và đầu kinh tế. Vì thế, việc phân phối này một mặt do sản xuất quy định, mặt khác lại có tác động rất quan trọng đối với sản xuất. Chỉ khi định một khi phối đáp ứng được các nhu cầu của sản xuất thì quá trình sản xuất mới có thể tiếp tục và không ngừng mở rộng.
